...
;(function($){
    ...
    Toolbar.prototype.addButton = function(newtag) {
        ...
        if (typeof this.tagToFunction[result.tag] !== 'undefined') {
            var $button = $("<li class=\"format-" + newtag + "\" title=\"" + newtag + "\">" + result.tag + "</li>");
    ...
    Toolbar.prototype.show = function() {
        ...
        for (var i = 0; i < this.options.allowedTags.length; i++) {
            ...
            this.$toolbar.children(".format-" + tag).toggleClass("active", this.editor.hasFormat(result.tag, result.attributes));
        }
