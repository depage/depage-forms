...
;(function($){
    ...
    // }}}
    // {{{ tagToFunction
    Toolbar.prototype.tagToFunction = {
        "b": "bold",
        "i": "italic"
    };
    // }}}
    // {{{ Toolbar.addButton
    Toolbar.prototype.addButton = function(tag) {
        if (typeof this.tagToFunction[tag] !== 'undefined') {
            var $button = $("<li>" + tag + "</li>");
            ...
            $button
                ...
                .on("click", function() {
                    if (editor.hasFormat(tag)) {
                        var func = "remove" + tagToFunction[tag].charAt(0).toUpperCase() + tagToFunction[tag].slice(1);
                        editor[func]();
                    } else {
                        editor[tagToFunction[tag]]();
                    }
                });
        }
    ...
    Toolbar.prototype.show = function() {
        ...
        $("body")
            .off("click.depageRtfToolbar")
            .on("click.depageRtfToolbar", function() {
                toolbar.hide();
            });
    ...
    Toolbar.prototype.setPositionBySelection = function() {
        ...
        this.$toolbar.offset({
            top: firstRect.top + scrollTop - 40,
